...
Nova.booting(function (Vue, router) {
    Vue.component('index-novafieldcheckboxes', __webpack_require__(11));
    Vue.component('detail-novafieldcheckboxes', __webpack_require__(14));
    Vue.component('form-novafieldcheckboxes', __webpack_require__(20));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getCheckedBoxesIds: function getCheckedBoxesIds(values) {
            var ids = [];
...
var render = function() {
  ...
  return _c(
    "span",
    { staticClass: "w-full" },
    _vm._l(_vm.availableOptions, function(value, option) {
      return _c("span", {
        key: option,
...
var update = __webpack_require__(3)("6bd2fde8", content, false, {});
      ...
      [
        _c(
          ...
          _vm._l(_vm.field.options, function(label, option) {
            return _c("div", { key: option, staticClass: "flex-auto" }, [
              _c("span", {
                staticClass: "inline-block rounded-full w-2 h-2 mr-1",
                class: _vm.optionClass(option)
              }),
